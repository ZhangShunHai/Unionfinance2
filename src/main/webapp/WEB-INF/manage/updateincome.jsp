...
<body>
<form action="${rootPath}manage/IncomeManager_updateIncome" method="post" onsubmit="return su();">
	<div class="container">
		<div class="row">
			<p class="current">当前位置：首页>>查看拨款>>修改拨款</p>
		</div>
	</div>
	<div id="body-one">
		<div class="container-one">
			<input type="hidden" name="income.in_operator" value="${manager.name }">
			<input type="hidden" name="income.in_id" value="${updateIncome.in_id}">
			<div class="row">	
				<div
					...
					<div class="col-lg-6 col-md-6  col-xs-6">
						<input type="text" name="income.in_time" class="form-control text" id="date" required="required" value="${updateIncome.in_time}"/>
					</div>
				</div>
				<div class="col-lg-4 col-md-4  col-xs-4">
					...
					<div class="col-lg-6 col-md-6  col-xs-6" style="margin-left:-18%;">
						<select name="income.in_entry" class="sel2 form-control">
							<option value="${updateIncome.in_entry }">${updateIncome.in_entry }</option>
				...
				<div
					...
					<div class="col-lg-6 col-md-6  col-xs-6">
						<input type="tel" name="income.in_money"
							...
							oninput="setCustomValidity('');" class="form-control" value="${updateIncome.in_money}"/>
					</div>
				</div>
				<div class="col-lg-4 col-md-4  col-xs-4">
					<div class="col-lg-6 col-md-6  col-xs-6">
					...
					<div class="col-lg-6 col-md-6  col-xs-6" style="margin-left:-18%;">
						<select name="income.in_union" class="form-control">
							<option value="${updateIncome.in_union }">${updateIncome.in_union }</option>
				...
				<div
					...
					<div class="col-lg-6 col-md-6  col-xs-6" style="margin-left:-4%;">
						<textarea class="form-control" rows="5" cols="29"
							name="income.in_remark">${updateIncome.in_remark }</textarea>
					</div>
